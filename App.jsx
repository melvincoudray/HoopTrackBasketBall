...
function ObservationPrintReport({ name, team }) {
...
function ObservationTab({ isCoach }) {
  ...
  return (
    <div>
      ...
      {current && (
        <div>
          <div className="screen-only" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
      ...
      {current && (
        <div className="print-only" id="observation-print-content">
          <ObservationPrintReport name={selected} team={current} />
        </div>
      )}
      <ExportModal report={exportReport} onClose={() => setExportReport(null)} />
    </div>
